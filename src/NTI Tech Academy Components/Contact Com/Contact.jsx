      ...
      <div className="bg-white shadow-md rounded-lg flex overflow-hidden max-w-4xl w-full">
        <div className="bg-yellow-400 w-1/3 p-8 flex flex-col justify-center items-center">
          ...
          <address className="not-italic mb-4">
            LIG - 2/21/422, Nehru Nagar,<br />
            Rewa, Madhya Pradesh 486001
          </address>
          <p className="mb-4 mr-32">
            <strong>Phone:</strong><br/> <a href="tel:09174253016">091742 53016</a>
          </p>
          <p className="mb-4">
            <strong>Email:</strong> <a href="mailto:info@ntitechacademy.com">info@ntitechacademy.com</a>
          </p>
          <p>
            <strong>Website:</strong> <a href="http://www.ntitechacademy.com">www.ntitechacademy.com</a>
          </p>
        </div>
        <div className="bg-white w-2/3 p-8 flex flex-col justify-center">
          ...
          <h3 className="text-3xl font-bold mb-4">Get In Touch <span className="text-yellow-500">With Us</span></h3>
          <p className="mb-4">
